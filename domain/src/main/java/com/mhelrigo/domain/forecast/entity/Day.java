...
public class Day{
	...
	public Day(double avgvisKm, double uv, double avgtempF, double avgtempC, int dailyChanceOfSnow, double maxtempC, double maxtempF, double mintempC, double avgvisMiles, int dailyWillItRain, double mintempF, double totalprecipIn, double avghumidity, Condition condition, double maxwindKph, double maxwindMph, int dailyChanceOfRain, double totalprecipMm, int dailyWillItSnow) {
