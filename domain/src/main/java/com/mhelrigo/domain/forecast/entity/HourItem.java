...
public class HourItem {
    ...
    public HourItem(double feelslikeC, double feelslikeF, int windDegree, double windchillF, double windchillC, double tempC, double tempF, int cloud, double windKph, double windMph, int humidity, double dewpointF, int willItRain, double uv, double heatindexF, double dewpointC, int isDay, double precipIn, double heatindexC, String windDir, double gustMph, double pressureIn, int chanceOfRain, double gustKph, double precipMm, Condition condition, int willItSnow, double visKm, int timeEpoch, String time, int chanceOfSnow, double pressureMb, double visMiles) {
    ...
    public String getDewPointCForDisplaying() {
        return getDewpointC() + "%";
    }
    ...
    public String getHeatIndexCForDisplaying() {
        return getHeatindexC() + "%";
    }
